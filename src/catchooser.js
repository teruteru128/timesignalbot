...
const CAT_EMOJIS = ['\\N{CAT FACE}', '\\N{CAT}', '\\N{CAT}\\N{ZERO WIDTH JOINER}\\N{BLACK LARGE SQUARE}',
  '\\N{CRYING CAT}', '\\N{SMILING CAT WITH HEART-EYES}', '\\N{CAT WITH TEARS OF JOY}', '\\N{KISSING CAT}',
  '\\N{POUTING CAT}', '\\N{WEARY CAT}', '\\N{GRINNING CAT WITH SMILING EYES}', '\\N{GRINNING CAT}',
  '\\N{CAT WITH WRY SMILE}', '\\N{PAW PRINTS}'];
